 ...
 */
@Controller
public class ReadTransformWriteController {

	private static Logger logger = Logger.getLogger(ReadTransformWriteController.class);
	 ...
	 */
	@Autowired
	public ReadTransformWriteController(EventDetailsRepository eventDetailsRepository) {		
